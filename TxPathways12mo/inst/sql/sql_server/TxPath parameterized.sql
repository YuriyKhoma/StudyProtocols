...
author:  Jon Duke; revised by Ray Chen
description:
...
IF OBJECT_ID('#@studyName_drug_seq_summ', 'U') IS NOT NULL
	DROP TABLE #@studyName_drug_seq_summ;

IF OBJECT_ID('@studyName_@sourceName_summ', 'U') IS NOT NULL
	DROP TABLE @studyName_@sourceName_summ;
...
select  tempcohort.person_id, tempcohort.INDEX_DATE,COHORT_END_DATE, tempcohort.observation_period_start_date, tempcohort.observation_period_end_date
from 
(
  ...
  (
  	...
  	(
  		...
  		(
  			...
  			JOIN @cdmSchema.PERSON p on p.PERSON_ID = de.PERSON_ID
  ...
  WHERE r.RowNumber = 1) tempcohort
  join --require patients to also have neoplastic disease, excluding lipomas and benign disease
  (
    select distinct cond.person_id
    from @cdmSchema.condition_occurrence cond
    join (SELECT c.* 
    FROM @cdmSchema.concept_ancestor ca, @cdmSchema.concept c
    WHERE ca.ancestor_concept_id = 438112 
    AND ca.descendant_concept_id = c.concept_id 
    EXCEPT
    SELECT c.* 
    FROM @cdmSchema.concept_ancestor ca, @cdmSchema.concept c 
    WHERE (ca.ancestor_concept_id = 435506 OR ca.ancestor_concept_id = 4111953)
    AND ca.descendant_concept_id = c.concept_id ) blah
    on blah.concept_id=cond.condition_concept_id
  ) cancer
  on cancer.person_id=tempcohort.person_id  
;
...
(
	...
	JOIN @cdmSchema.CONCEPT_ANCESTOR ca on co.CONDITION_CONCEPT_ID = ca.DESCENDANT_CONCEPT_ID and ca.ANCESTOR_CONCEPT_ID in (@excludedxlist)
...
(
	...
	JOIN @cdmSchema.CONCEPT_ANCESTOR ca on de.DRUG_CONCEPT_ID = ca.DESCENDANT_CONCEPT_ID and ca.ANCESTOR_CONCEPT_ID in (@txlist)
...
(
	...
	JOIN @cdmSchema.CONCEPT_ANCESTOR ca on ce.CONDITION_CONCEPT_ID = ca.DESCENDANT_CONCEPT_ID and ca.ANCESTOR_CONCEPT_ID in (@dxlist)
...
from @cdmSchema.drug_era de0
inner join #@studyName_MatchCohort c1
on de0.person_id = c1.person_id
where drug_concept_id in (select descendant_concept_id from @cdmSchema.concept_ancestor where ancestor_concept_id in (@txlist))
...
create table #@studyName_drug_seq_summ
(
	index_year int,
	d1_concept_id int,
	d2_concept_id int,
...
{@smallcellcount != 1} ? {
  ...
  create table #@studyName_drug_seq_summ_temp
  (
    index_year int,
  	d1_concept_id int,
  	d2_concept_id int,
  																...
  																(
  																	...
  																	from
  																		...
  																		select index_year,  
  																			...
  																			case when d20_concept_id > 0 and num_persons < @smallcellcount then 'Other' when d19_concept_id = -1 then null else d20_concept_name end as d20_concept_name,
  																			sum(num_persons) as num_persons
  																		from #@studyName_drug_seq_summ_temp
  																		group by index_year,  
...
TRUNCATE TABLE #@studyName_drug_seq_summ_temp;
DROP TABLE #@studyName_drug_seq_summ_temp;
...
create table @resultsSchema.@studyName_@sourceName_summ
(
...
insert into @resultsSchema.@studyName_@sourceName_summ (count_type, num_persons)
...
create table @resultsSchema.@studyName_@sourceName_person_cnt
(
	index_year int,
	num_persons int
);

insert into @resultsSchema.@studyName_@sourceName_person_cnt (index_year, num_persons)
select index_year, num_persons
from
(
select index_year, sum(num_persons) as num_persons
from #@studyName_drug_seq_summ
group by index_year
) t1
;
...
create table @resultsSchema.@studyName_@sourceName_seq_cnt
(
	index_year int,
	d1_concept_id int, 
	d2_concept_id int, 
...
insert into @resultsSchema.@studyName_@sourceName_seq_cnt (index_year, d1_concept_id, d2_concept_id, d3_concept_id, d4_concept_id, d5_concept_id, d6_concept_id, d7_concept_id, d8_concept_id, d9_concept_id, d10_concept_id, d11_concept_id, d12_concept_id, d13_concept_id, d14_concept_id, d15_concept_id, d16_concept_id, d17_concept_id, d18_concept_id, d19_concept_id, d20_concept_id, d1_concept_name, d2_concept_name, d3_concept_name, d4_concept_name, d5_concept_name, d6_concept_name, d7_concept_name, d8_concept_name, d9_concept_name, d10_concept_name, d11_concept_name, d12_concept_name, d13_concept_name, d14_concept_name, d15_concept_name, d16_concept_name, d17_concept_name, d18_concept_name, d19_concept_name, d20_concept_name, num_persons)
select index_year, d1_concept_id, d2_concept_id, d3_concept_id, d4_concept_id, d5_concept_id, d6_concept_id, d7_concept_id, d8_concept_id, d9_concept_id, d10_concept_id, d11_concept_id, d12_concept_id, d13_concept_id, d14_concept_id, d15_concept_id, d16_concept_id, d17_concept_id, d18_concept_id, d19_concept_id, d20_concept_id, d1_concept_name, d2_concept_name, d3_concept_name, d4_concept_name, d5_concept_name, d6_concept_name, d7_concept_name, d8_concept_name, d9_concept_name, d10_concept_name, d11_concept_name, d12_concept_name, d13_concept_name, d14_concept_name, d15_concept_name, d16_concept_name, d17_concept_name, d18_concept_name, d19_concept_name, d20_concept_name, num_persons
from #@studyName_drug_seq_summ
;
...
DROP TABLE #@studyName_drug_seq;
TRUNCATE TABLE #@studyName_drug_seq_summ;
DROP TABLE #@studyName_drug_seq_summ;
